    ...
    Credentials({
      ...
      async authorize(credentials) {
        ...
        try {
          ...
          // Call backend directly here to avoid circular import with customFetch
          ...
          return {
            ...
            userId: id || credentials.email,
            username: username || credentials.email,
            email: email || credentials.email,
            name: name ?? (firstName && lastName ? `${firstName} ${lastName}` : (firstName || lastName || credentials.email)),
            accessToken: access,
...
// Consumers should import and use `authOptions` with NextAuth route handlers.
