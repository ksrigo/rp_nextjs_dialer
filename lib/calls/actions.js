    ...
    try {
        ...
        const acceptOptions = {
            sessionDescriptionHandlerOptions: {
                ...
                stream: stream, // This is crucial - pass the actual stream
...
export const handleEndCall = async (session, sipUserAgent) => {
    try {
        // Close session description handler
        ...
        // Stop any locally cached stream from previous call
        ...
        // IMPORTANT: Do not stop the UserAgent here; keep REGISTER alive for next calls
